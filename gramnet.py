...
class DatasetGen(Dataset):
    def __init__(self, size, d, n, cloud_1, cloud_2, ce=False, device = 'cpu', special=True) -> None:
        ...
        if special:
            ...
            self.addOrthogonal()
        self.addPerm()
        self.addGaussian(0, 0.1) #TODO Add Gaussian 
        self.centralize()
...
if __name__ == "__main__":
    ...
    res2 = {'EGNNaleph' :   {'2_body_ex_1' : None, '2_body_ex_2' : None,'2_body_ex_3' : None , '2022' : None, 'gortler_3' : None, 'gortler_4' : None}}
    points = {'2_body_ex_1' : (A, B, 3,5), '2_body_ex_2' : (C, D, 3, 7),'2_body_ex_3' : (EE, FF, 3, 6) , '2022' : (X_p, X_m, 3, 6),'gortler_3' : (a,b, 6,6), 'gortler_4' : (gortler_4_a, gortler_4_b,8,8) }
